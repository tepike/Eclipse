...
public class main extends JFrame implements KeyListener {
    ...
    static JLabel SegedSzoveg3 = new JLabel("VÉSZKILÉPÉS (N)");
    ...
    static private int HatralevoKor=0;
    ...
    public main() throws AWTException {
    	...
    	try {
			...
			StreamResult r=new StreamResult(new File("TepiMakro.xml"));
			t.transform(s, r);
			System.out.println("Fajl letrehozva | frissitve");
...
try {
			...
			File inputFile=new File("TepiMakro.xml");
			DocumentBuilderFactory a=DocumentBuilderFactory.newInstance();
			DocumentBuilder b=a.newDocumentBuilder();
	...
	*/
	        	 ...
	        	 if (e.getKeyCode() == NativeKeyEvent.VC_UP) {
	                 ...
	                 lblIgen.setText("Nem");
	                    ...
	                    EgerFrissit();
		                 ...
		                 aktiv=true;
		                 setBackground(new Color(0, 100, 0, 40));
        ...
        Ablak2.setSize(frameWidth + 500, frameHeight + 200);
        Ablak2.setLocation(frameX + 100, frameY);
        ...
        SegedSzoveg3.setBounds(180, 244, 180, 36);
