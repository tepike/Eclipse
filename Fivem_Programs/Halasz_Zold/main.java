...
public class main extends JFrame implements KeyListener {
    ...
    public static int Keresett_Piros_Min=20;
    public static int Keresett_Piros_Max=70;
    public static int Keresett_Zold_Min=160;
    public static int Keresett_Zold_Max=200;
    public static int Keresett_Kek_Min=20;
    public static int Keresett_Kek_Max=70;
    ...
    public main() throws AWTException {
        ...
        SegedSzoveg3.setBounds(177, 333, 250, 36);
        ...
        Szinvalaszto_Btn.setBounds(5, 343, 113, 23);
